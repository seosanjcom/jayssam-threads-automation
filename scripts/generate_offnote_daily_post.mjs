...
const NOTES = [
  ...
  ["class_preparation", "수업 전 준비", "수업 준비를 오래 했다고 수업이 좋은 건 아니다.\n아이들이 어디에서 웃고, 어디에서 멈출지까지 생각해두면 그때부터 준비가 된다."],
  ["say_no_project", "안 하는 일", "요즘은 할 수 있는 일보다 안 할 일을 더 빨리 고른다.\n시간이 모자라서가 아니라, 내가 잘하는 일에 여유를 남겨두고 싶어서."],
  ...
  ["conversation_after_class", "수업 뒤 대화", "수업 뒤에 부모님과 짧게 나누는 대화가 좋다.\n결과를 보고하는 시간이 아니라, 아이를 같이 이해하는 시간이 될 때가 있다."],
...
const REFLECTION_ENDINGS = [
  "대단한 방법은 아니어도, 이런 작은 기준이 쌓이면 일하는 하루가 꽤 편해진다.",
  "내가 오래 지키는 방식은 늘 거창하지 않다. 오늘도 내 리듬을 잃지 않는 쪽이면 충분하다.",
