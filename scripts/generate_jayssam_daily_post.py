...
TOPICS.extend([
    {
        "slug": "elementary-coding-unplugged",
        "keyword": "초등코딩",
        "title": "초등 코딩은 컴퓨터 앞에 오래 앉는 것보다 순서를 말로 설명하는 힘이 먼저입니다",
        "source_name": "초등 정보교육·디지털 기초소양",
        "source_urls": ["https://www.moe.go.kr/"],
        "hook": "초등 코딩을 시작한다고 바로 어려운 언어부터 볼 필요는 없습니다.\n먼저 아이가 순서, 조건, 반복을 말로 설명할 수 있는지가 중요합니다.",
        "body": [
            "초등 단계의 코딩은 문법보다 절차를 생각하는 연습에 가깝습니다.",
            "카드 정렬, 길 찾기, 요리 순서 설명처럼 컴퓨터 없이도 알고리즘 사고를 연습할 수 있습니다.",
            "부모가 볼 것은 결과 화면보다 아이가 왜 그 순서로 했는지 설명하는 힘입니다.",
        ],
        "slides": [
            ("01", "초등 코딩", "문법보다 순서 설명이 먼저입니다."),
            ("02", "조건", "만약 이렇게 되면 어떻게 할까요?"),
            ("03", "반복", "같은 일을 몇 번 반복하나요?"),
            ("04", "오류", "어디서 막혔는지 말할 수 있나요?"),
            ("05", "집에서", "길 찾기나 요리 순서를 말로 풀어보세요."),
            ("06", "핵심", "초등 코딩은 사고 언어입니다."),
        ],
        "resource": {
            "site": "교육부",
            "url_label": "moe.go.kr",
            "free": "디지털 기초소양 정책 자료",
            "menu": "초등 정보교육 자료 확인",
            "use": "초등 코딩 시작 전 부모 상담",
            "check": "순서·조건·반복을 말로 설명하는지 보기",
            "caution": "코딩 문법 암기부터 시작하지 않기",
            "search": "초등 코딩 언플러그드",
        },
        "expert": {
            "news_frame": "초등 정보교육은 코딩 언어보다 디지털 기초소양과 컴퓨팅 사고를 넓히는 방향으로 봐야 합니다.",
            "must_know": "초등 코딩의 출발점은 순서, 조건, 반복을 자기 말로 설명하는 힘입니다.",
            "avoid": "너무 이른 문법 학습은 아이가 코딩을 외우는 과목으로 느끼게 할 수 있습니다.",
            "check": "아이에게 왜 그 순서로 해결했는지 물어보세요.",
            "use_for": "초등 학부모 코딩 상담, 첫 수업 안내",
        },
    },
    {
        "slug": "middle-coding-python-start",
        "keyword": "중등코딩",
        "title": "중학생 파이썬은 문법 진도보다 작은 문제를 끝까지 고치는 경험이 중요합니다",
        "source_name": "중등 정보교과·파이썬 입문",
        "source_urls": ["https://www.moe.go.kr/"],
        "hook": "중학생이 파이썬을 배울 때 진도를 빨리 나가는 것만 보면 놓치는 게 있습니다.\n작은 오류를 직접 찾고 고치는 경험이 더 오래 남습니다.",
        "body": [
            "중등 코딩은 print, if, for를 많이 아는 것보다 문제를 나누고 테스트하는 태도가 중요합니다.",
            "오류 메시지를 읽고, 변수 값을 확인하고, 한 줄씩 바꿔보는 과정이 실력입니다.",
            "부모는 완성 작품보다 디버깅 기록과 설명 가능 여부를 봐야 합니다.",
        ],
        "slides": [
            ("01", "중등 코딩", "문법 진도보다 디버깅 경험입니다."),
            ("02", "핵심 1", "문제를 작게 나누나요?"),
            ("03", "핵심 2", "오류 메시지를 읽나요?"),
            ("04", "핵심 3", "변수 값을 확인하나요?"),
            ("05", "부모 체크", "완성보다 수정 과정을 물어보세요."),
            ("06", "핵심", "코딩 실력은 고치는 과정에서 자랍니다."),
        ],
        "resource": {
            "site": "교육부",
            "url_label": "moe.go.kr",
            ...
            "menu": "정보교과 교육과정 확인",
            "use": "중학생 코딩 학습 루틴 상담",
            "check": "디버깅 기록과 설명 가능 여부",
            "caution": "문법 진도표만 보지 않기",
            "search": "중등 정보교과 파이썬",
        },
        "expert": {
            "news_frame": "중등 정보교과는 코딩 문법 암기보다 문제해결 과정과 오류 수정 경험을 봐야 합니다.",
            "must_know": "파이썬을 배울 때 중요한 것은 문법 개수보다 오류를 읽고 고치는 습관입니다.",
            "avoid": "강사가 코드를 다 고쳐주면 아이의 문제해결 경험이 남지 않습니다.",
            "check": "오늘 고친 오류 하나를 아이가 설명할 수 있는지 확인하세요.",
            "use_for": "중등 코딩 수업 상담, 학부모 안내",
        },
    },
    {
        "slug": "highschool-coding-subject-choice",
        "keyword": "고등코딩",
        "title": "고등 코딩은 대회보다 정보 과목 선택과 진로 연결을 먼저 봐야 합니다",
        "source_name": "고등 정보교과·진로 선택",
        "source_urls": ["https://www.moe.go.kr/"],
        "hook": "고등학생 코딩을 이야기하면 대회나 포트폴리오부터 떠올리기 쉽습니다.\n하지만 먼저 볼 것은 학교 과목 선택과 진로 연결입니다.",
        "body": [
            "고등 코딩은 단순 스펙보다 수학, 과학, 사회 문제를 데이터와 절차로 풀어보는 경험이 중요합니다.",
            "정보 과목, 탐구 주제, 수행평가, 동아리 활동이 한 방향으로 이어질 때 기록의 힘이 생깁니다.",
            "부모는 대회 수상보다 아이가 어떤 문제를 코딩으로 설명하고 싶은지 봐야 합니다.",
        ],
        "slides": [
            ("01", "고등 코딩", "대회보다 과목과 진로 연결입니다."),
            ("02", "과목", "정보 과목 선택을 확인합니다."),
            ("03", "탐구", "코딩으로 풀 문제를 정합니다."),
            ("04", "기록", "수행평가와 동아리를 연결합니다."),
            ("05", "주의", "스펙만 쌓으면 방향이 흐려집니다."),
            ("06", "핵심", "코딩은 진로를 설명하는 도구입니다."),
        ],
        "resource": {
            "site": "교육부",
            "url_label": "moe.go.kr",
            "free": "고등 정보교과 교육과정",
            "menu": "고등 정보 과목 자료 확인",
            "use": "고등학생 진로·과목 선택 상담",
            "check": "탐구 주제와 정보 과목 연결",
            "caution": "대회 실적만 목표로 삼지 않기",
            "search": "고등 정보 교과 진로",
        },
        "expert": {
            "news_frame": "고등 코딩은 대회 실적보다 과목 선택, 탐구 주제, 진로 기록이 연결되는지가 중요합니다.",
            "must_know": "코딩은 독립 스펙이 아니라 관심 분야의 문제를 설명하는 언어가 될 때 힘이 생깁니다.",
            "avoid": "수상만 목표로 하면 학교 기록과 진로 방향이 분리될 수 있습니다.",
            "check": "아이가 코딩으로 설명하고 싶은 문제 하나를 말할 수 있는지 보세요.",
            "use_for": "고등 학부모 진로 상담, 정보 과목 선택 안내",
        },
    },
    {
        "slug": "coding-ai-data-literacy",
        "keyword": "AI데이터코딩",
        "title": "AI 시대 코딩은 앱 만들기보다 데이터 읽기와 질문 만들기가 더 중요해지고 있습니다",
        "source_name": "AI·데이터 리터러시 교육",
        "source_urls": ["https://www.moe.go.kr/"],
        "hook": "AI가 코드를 대신 써주는 시대라면 아이에게 필요한 코딩은 무엇일까요?\n핵심은 더 많은 문법이 아니라 데이터와 질문을 다루는 힘입니다.",
        "body": [
            "AI 시대에는 코드를 외우는 것보다 문제를 정의하고 데이터를 읽고 결과를 검토하는 능력이 중요해집니다.",
            "표, 그래프, 조건, 편향을 이해해야 AI 도구가 내놓은 답도 판단할 수 있습니다.",
            "아이에게 필요한 것은 프롬프트보다 먼저 좋은 질문과 검증 기준입니다.",
        ],
        "slides": [
            ("01", "AI 시대 코딩", "문법보다 질문과 데이터입니다."),
            ("02", "질문", "무엇을 풀 문제로 정하나요?"),
            ("03", "데이터", "표와 그래프를 읽나요?"),
            ("04", "검증", "AI 답을 의심해보나요?"),
            ("05", "주의", "자동화 결과만 믿지 않습니다."),
            ("06", "핵심", "코딩은 판단력과 연결됩니다."),
        ],
        "resource": {
            "site": "교육부",
            "url_label": "moe.go.kr",
            ...
            "menu": "AI 교육 정책 자료 확인",
            "use": "AI 시대 코딩 교육 상담",
            "check": "질문·데이터·검증 기준 확인",
            "caution": "AI가 만든 코드만 제출하지 않기",
            "search": "AI 데이터 리터러시 코딩",
        },
        "expert": {
            "news_frame": "AI 시대의 코딩 교육은 문법 암기보다 질문 설계, 데이터 해석, 결과 검증으로 확장되고 있습니다.",
            "must_know": "아이에게 필요한 코딩 역량은 코드를 많이 치는 것보다 문제를 정의하고 결과를 판단하는 힘입니다.",
            "avoid": "AI가 써준 코드를 그대로 믿으면 사고 과정이 비어 보일 수 있습니다.",
            "check": "AI 답이 맞는지 어떤 기준으로 확인했는지 물어보세요.",
            "use_for": "AI 코딩 교육 상담, 데이터 리터러시 안내",
        },
    },
])
